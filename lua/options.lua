...
-- Set the fold method to 'expr', which allows Neovim to use an expression to determine fold boundaries.
vim.opt.foldmethod = 'expr'

-- Define the expression used for folding; in this case, it uses the nvim-treesitter parser to intelligently fold code based on syntax.
vim.opt.foldexpr = 'nvim_treesitter#foldexpr()'

-- Set the initial fold level when opening a buffer; setting it to 99 means that all folds will be open by default, preventing any folds from being closed initially.
